...
{
    public partial class eTourist1Context : DbContext
    {
        public eTourist1Context()
        {
        }

        public eTourist1Context(DbContextOptions<eTourist1Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=.;Database=eTourist1TMP;Trusted_Connection=True;");
            }
        }
